...
class HPtuner:
    ...
    def __init__(self, model, method, total_budget=10000, max_budget_per_config=200, test_default_hyperparam=False):
        ...
        self.tuning_history = TuningAnalyst(method, type(model).__name__, total_budget, max_budget_per_config)
    ...
    def hyperband(self, loss):
        ...
        # We update total unique sampled number of our Tuning History (TuningAnalyst object)
