...
class TuningAnalyst:
    ...
    def save_all_results(self, path, experiment_title, dataset_name, training_size, test_accuracy, noise=None):
        ...
        """
        Saves all results saved by the TuningAnalyst
        ...
        # We save all important data for the TuningAnalyst in the path concerned
    ...
    def reset(self):
        ...
        """
        Resets TuningAnalyst to ignition values
        """
